    ...
    <div class="section">
        ...
        <div class="row">
            ...
            <div class="col s6">
                ...
                <div class="form-floating mb-3">
                    {!! Form::text('maximun_capacity', null, ['class'=>"form-control", 'placeholder'=>"Capacidad maxima", 'rows'=>1] ) !!}
                    <label for="maximun_capacity" class="form-label">Capacidad máxima de huespedes</label>
                </div>
                <div class="form-floating mb-3">
                    {!! Form::textarea('characteristics', null, ['class'=>"form-control", 'placeholder'=>"Caracteristicas", 'rows'=>1] ) !!}
                    <label for="caracteristicas">Características</label>
                </div>
                <div class="form-floating mb-3">
                    {!! Form::textarea('location', null, ['class'=>"form-control", 'placeholder'=>"Direccion", 'rows'=>1] ) !!}
                    <label for="location">Direccion</label>
                </div>
                <div class="form-floating mb-3">
                    {!! Form::textarea('price', null, ['class'=>"form-control", 'placeholder'=>"Valor", 'rows'=>1] ) !!}
